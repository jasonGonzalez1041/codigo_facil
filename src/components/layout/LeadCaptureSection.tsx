        ...
        return (
            <section className="py-16 bg-gradient-to-br from-green-50 to-emerald-100 dark:from-green-900/20 dark:to-emerald-900/20">
                <div className="max-w-4xl mx-auto px-4 text-center">
                    <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-8 border border-green-200 dark:border-green-700">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="text-center md:text-left">
                        <div className="flex items-center justify-center md:justify-start gap-2 mb-4">
                            ...
                            <span className="text-sm text-gray-600 dark:text-gray-300">+1,247 descargas</span>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-gray-700 dark:text-gray-300"><strong>Checklist de 25 puntos</strong> para sitios web que convierten</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Calculator className="w-6 h-6 text-blue-500 flex-shrink-0" />
                                <span className="text-gray-700 dark:text-gray-300"><strong>Calculadora de ROI</strong> para medir tu inversión</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <Download className="w-6 h-6 text-purple-500 flex-shrink-0" />
                                <span className="text-gray-700 dark:text-gray-300"><strong>Descarga inmediata</strong> + Copia por email</span>
                            </div>
                        </div>
                        ...
                        <form onSubmit={manejarEnvio} className="space-y-4">
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    required
                                    className="w-full px-4 py-3 border border-gray-300 dark:border-gray-600 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition duration-200 bg-white dark:bg-gray-700 text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400"
                                />
                            </div>
                        ...
                        <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
                            <div className="flex items-center justify-center space-x-4 text-sm text-gray-600 dark:text-gray-300">
                                <div className="text-center">
                                    <div className="font-bold text-gray-900 dark:text-white">1,247+</div>
                                    <div>Descargas</div>
                                </div>
                                <div className="text-center">
