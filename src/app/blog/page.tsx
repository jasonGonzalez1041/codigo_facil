...
export const metadata: Metadata = {
  title: "Blog Desarrollo Web | CodigoFacil.com",
  description: "Guías atemporales de desarrollo web, e-commerce y estrategias digitales para empresas LATAM. Contenido evergreen que genera valor perpetuo.",
  keywords: "desarrollo web evergreen, guías desarrollo Next.js, estrategias e-commerce atemporales, SEO evergreen LATAM",
}
      ...
      <section className="pb-12">
        <div className="container mx-auto px-6">
          {evergreenPosts.filter(post => post.featured).map(post => (
            <div key={post.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl overflow-hidden max-w-6xl mx-auto">
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {evergreenPosts.map(post => (
              <div key={post.id} className="bg-white dark:bg-gray-800 rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-all duration-300">
                <img 
                  src={post.image}
                  alt={post.title}
